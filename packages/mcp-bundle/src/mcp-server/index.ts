...
interface AdapterClientErrorOptions {
  code: string;
  retriable?: boolean;
  retryAfterMs?: number;
  envelope?: Envelope;
...
class AdapterClientError extends Error {
...
function determineToolRegistrar(server: any) {
